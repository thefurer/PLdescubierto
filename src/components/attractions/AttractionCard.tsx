...
export const AttractionCard = ({
  ...
  return (
    <>
      <div 
        className="group bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl smooth-transition transform hover:-translate-y-2 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-ocean focus-visible:ring-offset-2 image-card"
        style={{
      ...
      >
        <div className="relative h-48 overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent group-hover:from-black/30 smooth-transition"></div>
          <div className="absolute top-3 right-3 glass-card rounded-full px-3 py-1 flex items-center">
            <Star size={16} className="text-amber-500 mr-1" fill="currentColor" aria-hidden="true" />
        ...
        <div className="p-6">
          <h3 className="text-lg font-semibold text-ocean-dark mb-3 group-hover:text-green-primary smooth-transition leading-snug">
            {attraction.name}
          </h3>
          ...
          <div className="flex items-center text-ocean">
            <MapPin size={16} className="mr-2 text-green-primary" aria-hidden="true" />
