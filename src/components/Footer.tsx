  ...
  return <footer className="bg-ocean-dark text-white">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
          ...
          <p className="mt-2 text-sm">Un escaparate del paraíso costero de Ecuador. Diseñado para amantes de la naturaleza y aventureros. Hecho por Abel Castillo - SmartCityCore - Puerto López</p>
        </div>
      </div>
    </footer>;
};
