      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        <div className="group relative p-6 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-2xl border border-white/20 backdrop-blur-sm hover:from-blue-500/20 hover:to-cyan-500/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <h4 className="text-xl font-semibold text-white mb-3">{t.vrExperience}</h4>
        ...
        <div className="group relative p-6 bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-2xl border border-white/20 backdrop-blur-sm hover:from-purple-500/20 hover:to-pink-500/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <h4 className="text-xl font-semibold text-white mb-3">{t.socialInteraction}</h4>
        ...
        <div className="group relative p-6 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 rounded-2xl border border-white/20 backdrop-blur-sm hover:from-emerald-500/20 hover:to-teal-500/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <h4 className="text-xl font-semibold text-white mb-3">{t.navigation}</h4>
      ...
      <div className="bg-gradient-to-r from-white/5 to-white/10 rounded-3xl p-8 border border-white/20 backdrop-blur-sm">
        <div className="text-center mb-8">
          <h4 className="text-2xl font-bold text-white mb-3">
            {t.multiDeviceExperience}
          </h4>
          <p className="text-white/80 text-lg">
            {t.multiDeviceSubtitle}
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="group text-center p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300 hover:scale-105">
            ...
            <h5 className="text-white font-semibold mb-1">{t.desktop}</h5>
            <p className="text-white/60 text-sm">{t.fullExperience}</p>
          </div>
          ...
          <div className="group text-center p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300 hover:scale-105">
            ...
            <h5 className="text-white font-semibold mb-1">{t.mobile}</h5>
            <p className="text-white/60 text-sm">{t.touchOptimized}</p>
          </div>
          ...
          <div className="group text-center p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300 hover:scale-105">
            ...
            <p className="text-white/60 text-sm">{t.totalImmersion}</p>
          </div>
          ...
          <div className="group text-center p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300 hover:scale-105">
            ...
            <h5 className="text-white font-semibold mb-1">{t.console}</h5>
            <p className="text-white/60 text-sm">{t.gamingControl}</p>
          </div>
        </div>
