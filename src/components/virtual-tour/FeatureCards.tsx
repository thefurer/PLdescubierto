...
const FeatureCards = ({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 hover:bg-black/30 transition-all border border-blue-500/20 hover:border-blue-500/40">
        <div className="flex items-center gap-3 mb-4">
        ...
        <button className="text-blue-500 flex items-center gap-1 hover:text-white transition-colors text-sm font-medium">
          {texts.explore} <ChevronRight size={16} />
        </button>
      </div>
      
      <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 hover:bg-black/30 transition-all border border-blue-600/20 hover:border-blue-600/40">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-12 h-12 rounded-full bg-gradient-to-r from-blue-700 to-blue-900 flex items-center justify-center">
            <Video className="text-white" size={24} />
          </div>
          <h4 className="text-white font-bold text-lg">{texts.immersive}</h4>
        </div>
        <p className="text-white/70 mb-4">{texts.immersiveDesc}</p>
        <button className="text-blue-600 flex items-center gap-1 hover:text-white transition-colors text-sm font-medium">
          {texts.explore} <ChevronRight size={16} />
        </button>
      </div>
    </div>
